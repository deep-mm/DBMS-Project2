...
import java.io.File;
import src.file.FileMgr;
import src.log.LogMgr;
import src.buffer.BufferMgr;
import src.tx.Transaction;
import src.metadata.MetadataMgr;
import src.plan.*;
import src.index.planner.IndexUpdatePlanner;
import src.opt.HeuristicQueryPlanner;
...
public class SimpleDB {
   ...
   public static String LOG_FILE = "src.log";
