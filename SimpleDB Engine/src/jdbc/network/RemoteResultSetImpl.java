...
class RemoteResultSetImpl extends UnicastRemoteObject implements RemoteResultSet {
    ...
    * @see src.jdbc.network.RemoteResultSet#next()
    */
    ...
    * @see src.jdbc.network.RemoteResultSet#getInt(java.lang.String)
    */
    ...
    * @see src.jdbc.network.RemoteResultSet#getMetaData()
    */
    ...
    * @see src.jdbc.network.RemoteResultSet#close()
    */
