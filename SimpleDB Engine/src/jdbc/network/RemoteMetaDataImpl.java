package src.jdbc.network;

import src.record.Schema;
...
public class RemoteMetaDataImpl extends UnicastRemoteObject implements RemoteMetaData {
    ...
    * @see src.jdbc.network.RemoteMetaData#getColumnCount()
    */
    ...
    * @see src.jdbc.network.RemoteMetaData#getColumnName(int)
    */
    ...
    * @see src.jdbc.network.RemoteMetaData#getColumnType(int)
    */
    ...
    * @see src.jdbc.network.RemoteMetaData#getColumnDisplaySize(int)
    */
