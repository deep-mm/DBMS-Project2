...
class RemoteStatementImpl extends UnicastRemoteObject implements RemoteStatement {
    ...
    * @see src.jdbc.network.RemoteStatement#executeQuery(java.lang.String)
    */
    ...
    * which executes it.
    * @see src.jdbc.network.RemoteStatement#executeUpdate(java.lang.String)
    */
