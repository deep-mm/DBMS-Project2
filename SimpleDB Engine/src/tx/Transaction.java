...
import src.buffer.*;
import src.tx.recovery.*;
import src.tx.concurrency.ConcurrencyMgr;
...
public class Transaction {
    ...
    * {@link src.server.SimpleDB}.
    * Those objects are created during system initialization.
    * Thus this constructor cannot be called until either
    * {@link src.server.SimpleDB#init(String)} or 
    * {@link src.server.SimpleDB#initFileLogAndBufferMgr(String)} or
    * is called first.
    */
