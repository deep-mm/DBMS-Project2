package src.index.btree;

import static java.sql.Types.INTEGER;
import src.file.BlockId;
import src.tx.Transaction;
import src.record.*;
import src.index.Index;
import src.query.Constant;
...
public class BTreeIndex implements Index {
    ...
    * and getDataRid.
    * @see src.index.Index#beforeFirst(src.query.Constant)
    */
    ...
    * @see src.index.Index#getDataRid()
    */
    ...
    * @see src.index.Index#insert(src.query.Constant, src.record.RID)
    */
    ...
    * @see src.index.Index#delete(src.query.Constant, src.record.RID)
    */
