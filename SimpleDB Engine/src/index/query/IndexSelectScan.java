package src.index.query;

import src.record.RID;
import src.index.Index;
import src.record.TableScan;
import src.query.*;
...
public class IndexSelectScan implements Scan {
    ...
    * @see src.query.Scan#beforeFirst()
    */
    ...
    * @see src.query.Scan#getInt(java.lang.String)
    */
   ...
   /**
    * Returns the value of the field of the current data record.
    * @see src.query.Scan#getString(java.lang.String)
    */
   ...
   /**
    * Returns the value of the field of the current data record.
    * @see src.query.Scan#getVal(java.lang.String)
    */
    ...
    * @see src.query.Scan#hasField(java.lang.String)
    */
